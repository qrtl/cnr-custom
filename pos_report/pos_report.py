...
class pos_report(osv.osv_memory):
    ...
    _columns = {
        ...
        'total_with_tax2': fields.float(u'総売上'),
        'tax': fields.integer(u'消費税'),
        'tax2': fields.float(u'消費税'),
        'consum_delivery': fields.integer(u'その他控除'),
        'consum_delivery2': fields.float(u'その他控除'),
        'total_without_tax': fields.integer(u'純売上'),
        'total_without_tax2': fields.float(u'純売上'),
        'total_cash': fields.integer(u'HaRuNe店現金'),
        'total_cash2': fields.float(u'HaRuNe店現金'),
        'total_invoice': fields.integer(u'売掛金'),
        'total_invoice2': fields.float(u'売掛金'),
        'total_card': fields.integer(u'ｸﾚｼﾞｯﾄ(Square)'),
        'total_card2': fields.float(u'ｸﾚｼﾞｯﾄ(Square)'),
        'total_ticket': fields.integer(u'商品券'),
        'total_ticket2': fields.float(u'商品券'),
        'total_virtual_currency': fields.integer(u'商品券釣'),
        'total_virtual_currency2': fields.float(u'商品券釣'),
        'total_rebate': fields.integer(u'電子ﾏﾈｰ'),
        'total_rebate2': fields.float(u'電子ﾏﾈｰ'),
        'total_return': fields.integer(u'取消・返品'),
        'total_return2': fields.float(u'取消・返品'),
        'base_cash': fields.float(u'釣銭金額'),
        'cash_increase': fields.float(u'現金増減額'),
        'cash_hand': fields.float(u'現金残高'),
